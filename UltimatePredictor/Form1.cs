...
namespace UltimatePredictor
{
    public partial class Form1 : Form
    {
        ...
        private readonly string PREDICTIONS_PATH = $"{Environment.CurrentDirectory}\\predictionConfig.json";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                var data = File.ReadAllText(PREDICTIONS_PATH);
            ...
            finally
            {
                ...
                {
                    MessageBox.Show("Predictional list is empty! Try layter");
                    Close();
                }
            }
        }
